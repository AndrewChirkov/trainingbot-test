    ...
    timetables.forEach(timetable => {
      ...
      if (prevTimetableEquals) {
        const newTimetable = {
          ...
          timeMs: selectTimeMs,
          time: time,
          inventory: this.user.state.inventory,
          inventoryUsing: this.user.state.inventoryUsing,
          maxClientsUsing: this.user.state.maxClientsUsing,
          maxClients: this.user.state.maxClients,
